...
package com.zhihuminus.editor

import com.zhihuminus.data.ZhihuJson
import com.zhihuminus.util.ZhihuFetchSignature
...
private val RFC1123_MONTH_NAMES =
...
private fun sha1(input: ByteArray): ByteArray {
    ...
    while (chunkOffset < padded.size) {
        ...
        for (index in 16 until 80) {
            words[index] =
                (words[index - 3] xor words[index - 8] xor words[index - 14] xor words[index - 16]).rotateLeft(1)
        }
