...
private const val MAIN_ACTIVITY_CLASS = "com.zhihuminus.MainActivity"
...
suspend fun getHighestQualityVideoUrl(
    context: Context,
        ...
        override fun shouldOverrideUrlLoading(view: WebView, request: WebResourceRequest): Boolean {
            ...
            if (request.url.host!!.endsWith("zhihu.com") &&
                ...
                context.startActivity(
                    Intent(Intent.ACTION_VIEW, request.url).setClassName(
                        context,
