...
class AppRouterRoundTripTest {
    ...
    fun settingsPages() {
        ...
        assertRoundTrip(Account.RecommendSettings(setting = "k"), "zhminus://settings/recommend?setting=k")
        assertRoundTrip(Account.RecommendSettings.Blocklist, "zhminus://settings/blocklist")
        assertRoundTrip(Account.RecommendSettings.BlockedFeedHistory, "zhminus://settings/blocked-feed-history")
